...
@Component({
  ...
  templateUrl: './invoices-admin-dashboard.component.html',
  styleUrls: ['./invoices-admin-dashboard.component.scss']
})
export class InvoicesAdminDashboardComponent implements OnInit, OnDestroy {
